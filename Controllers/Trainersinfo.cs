...
{
    public class Trainersinfo : Controller
    {
        private readonly ModelContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public Trainersinfo(ModelContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create(Class2 class2)
        {
            if (ModelState.IsValid)
            {
                ...
                Userinfo userinfo = new Userinfo
                {
                    ...
                    Roleid = 2, // Roleid to 3 for member
            ...
            ViewData["Roleid"] = new SelectList(_context.Roles, "Roleid", "Roleid", 2); // Default value in case of error
            return View(class2);
        }
